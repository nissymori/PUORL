...
def make_classifier_params_path(config):
    ...
    sas_params = os.path.join(
        os.path.dirname(os.path.dirname(__file__)),
        "params/classifier",
        f"{config.method}/{config.env_name}/{config.data.shift}/{data_quality}/sas/model_positive_ratio={config.data.positive_ratio}_labeled_ratio={config.data.labeled_ratio}.pt",
    )
    sa_params = os.path.join(
        os.path.dirname(os.path.dirname(__file__)),
        "params/classifier",
        f"{config.method}/{config.env_name}/{config.data.shift}/{data_quality}/sa/model_positive_ratio={config.data.positive_ratio}_labeled_ratio={config.data.labeled_ratio}.pt",
    )
